...
<body>
   ...
   // 	int minute = ((int)(target.get("time")) / 60) % 60;
	//	int second = (int)(target.get("time")) % 60;  
		...
		<section class="contents">
			<div class="d-flex border border-success p-3">
				...
				<div>
					<div class="display-4 font-weight-bold"><%=target.get("title") %></div>
					...
					<div class="d-flex">
						...
						<div class="ml-4">
							...
							<div><%=((int)(target.get("time")) / 60) % 60 %> :	 <%=(int)(target.get("time")) % 60 %></div>
